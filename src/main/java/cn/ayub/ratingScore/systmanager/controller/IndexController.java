package cn.ayub.ratingScore.systmanager.controller;

import cn.ayub.ratingScore.commons.base.BaseController;
import cn.ayub.ratingScore.commons.csrf.CsrfToken;
import cn.ayub.ratingScore.commons.shiro.captcha.DreamCaptcha;
...
public class IndexController extends BaseController {
   ...
   // @CsrfToken(remove =true)
    ...
    @CsrfToken(remove =true)
    @ResponseBody
    public Object validateCaptcha(HttpServletRequest request, HttpServletResponse response,String captcha){
        try{
