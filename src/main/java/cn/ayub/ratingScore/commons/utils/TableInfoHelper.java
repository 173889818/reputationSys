...
public class TableInfoHelper {
    ...
    public synchronized static TableInfo initTableInfo(MapperBuilderAssistant builderAssistant, Class<?> clazz) {
        ...
        if (table != null && com.baomidou.mybatisplus.toolkit.StringUtils.isNotEmpty(table.value())) {
            tableName = table.value();
        } else {
            // 开启字段下划线申明
            if (globalConfig.isDbColumnUnderline()) {
                tableName = com.baomidou.mybatisplus.toolkit.StringUtils.camelToUnderline(tableName);
            }
            // 大写命名判断
            if (globalConfig.isCapitalMode()) {
                ...
                // 首字母小写
                tableName = com.baomidou.mybatisplus.toolkit.StringUtils.firstToLowerCase(tableName);
            }
        }
         ...
         * 未发现主键注解，提示警告信息
		 */
        if (com.baomidou.mybatisplus.toolkit.StringUtils.isEmpty(tableInfo.getKeyColumn())) {
    ...
    private static boolean initTableId(GlobalConfiguration globalConfig, TableInfo tableInfo, Field field, Class<?> clazz) {
        ...
        if (tableId != null) {
            if (com.baomidou.mybatisplus.toolkit.StringUtils.isEmpty(tableInfo.getKeyColumn())) {
                ...
                if (com.baomidou.mybatisplus.toolkit.StringUtils.isNotEmpty(tableId.value())) {
                    column = tableId.value();
                    tableInfo.setKeyRelated(true);
                } else {
                    // 开启字段下划线申明
                    if (globalConfig.isDbColumnUnderline()) {
                        column = com.baomidou.mybatisplus.toolkit.StringUtils.camelToUnderline(column);
                        tableInfo.setKeyRelated(true);
                    }
                    // 全局大写命名
                    if (globalConfig.isCapitalMode()) {
    ...
    private static boolean initTableField(GlobalConfiguration globalConfig, TableInfo tableInfo, List<TableFieldInfo> fieldList,
        ...
        if (tableField != null) {
            ...
            if (com.baomidou.mybatisplus.toolkit.StringUtils.isNotEmpty(tableField.value())) {
            ...
            if (com.baomidou.mybatisplus.toolkit.StringUtils.isNotEmpty(tableField.el())) {
                el = tableField.el();
            }
