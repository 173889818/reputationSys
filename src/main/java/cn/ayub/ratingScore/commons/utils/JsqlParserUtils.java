    ...
    public static CountOptimize jsqlparserCount(CountOptimize countOptimize, String originalSql) {
        ...
        try {
            ...
            if (distinct != null || CollectionUtils.isNotEmpty(groupBy)) {
                sqlCount = String.format(com.baomidou.mybatisplus.toolkit.SqlUtils.SQL_BASE_COUNT, selectStatement.toString());
            ...
            sqlCount = String.format(com.baomidou.mybatisplus.toolkit.SqlUtils.SQL_BASE_COUNT, originalSql);
        }
        countOptimize.setCountSQL(sqlCount);
        return countOptimize;
    }
